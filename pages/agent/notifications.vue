<template>
  <view class="sub-page">
    <view class="nav"><text @tap="back">‹</text><b>消息通知</b><text v-if="notifications.length" class="read-all" @tap="readAll">全部已读</text><view v-else /></view>
    ...
    <view v-else-if="!loading" class="empty"><text>♧</text><b>暂无最新消息</b><p>平台动态会第一时间通知你</p></view>
