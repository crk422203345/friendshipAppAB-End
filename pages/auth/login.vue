  ...
  <view class="auth-page" :class="`portal-${portal.code}`">
    ...
    <view class="content safe-area">
      ...
      <view class="heading">
        ...
        <text class="subtitle">{{ loginType === 'password' ? '使用账号密码登录，开启你的工作台' : '使用邮箱登录，开启你的工作台' }}</text>
      </view>
      ...
      <view class="login-card">
        ...
        <view class="field">
          <text class="field-label">{{ loginType === 'password' ? '账号' : '邮箱' }}</text>
          <input v-model="email" type="text" :placeholder="loginType === 'password' ? '请输入账号' : '请输入邮箱地址'" placeholder-class="placeholder" />
        </view>
